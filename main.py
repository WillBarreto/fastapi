...
def procesar_mensaje_prospecto_estructurado(
    ...
    try:
        # ====================================================
        # AUDITORÍA DEL ALCANCE GENERAL DE LA CONVERSACIÓN
        # ====================================================
        ...
        print(
            "🔎 AUDITORÍA ALCANCE CONVERSACIONAL: "
            + json.dumps(
                resultado_alcance_auditoria,
                ensure_ascii=False,
                default=str,
        ...
        # La clasificación todavía no controla el flujo.
        # El procesamiento actual continúa sin cambios.
